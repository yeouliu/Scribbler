...
WhiteboardDesigner = function(witeboardConfig, whiteboardId, user, pubSubUrl, pubSubTransport) {
     ...
     */
    this.config = witeboardConfig; //whiteboard configuration
    /**
     * Whiteboard's id.
     * @public
     * @type uuid
     */    
    this.whiteboardId = whiteboardId; //unique whiteboard ID
    /**
     * User which works with this whiteboard.
     * @public
     * @type string
     */    
    this.user = user; //name of the current user working on the board
    /**
     * URL for bidirectional communication.
     * @public
     * @type string
     */    
    this.pubSubUrl = pubSubUrl; //Publish/Subscribe URL used for 2 way communication
    /**
    ...
    //Offset() used to find current location of an element
                ...
                switch (action) {
                    ...
                    case "remove" :
                        ...
                        if (hbr == null) {
                            // not found ==> nothing to do
                            if (_self.logging) {
                                logDebug("Element does not exist in the whiteboard anymore");
                            }
                            break;
                        }
